...
helm.sh/chart: {{ include "wordpress-chart.chart" . }}
...
*/}}
{{- define "wordpress-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "wordpress-chart.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
